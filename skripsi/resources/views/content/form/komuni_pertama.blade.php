    ...
    <div class="row">
        ...
        <div class="col-8">
            <div class="h1 text-center">
                <p>Form Registrasi Sakramen Komuni Pertama</p>
            </div>
            <div class="row">
            ...
            <form action="/komuni-pertama/create" method="post" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="exampleInputBuku1"
                        placeholder="Masukan  Hal dan No Buku Baptis" name="buku_baptis">
                </div>
                <div class="form-group">
                    <label for="exampleInputSekolah1">Nama Sekolah</label>
                    <input type="text" class="form-control" id="exampleInputSekolah1"
                        placeholder="Masukan Nama Sekolah dan Kelas" name="nama_sekolah">
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="exampleInputLingkungan1"
                        placeholder="Masukan Nama Lingkungan dan Paroki" name="lingkungan_paroki">
                </div>
                <div class="form-group">
