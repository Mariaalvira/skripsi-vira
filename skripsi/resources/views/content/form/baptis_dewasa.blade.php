...
<div class="row">
    ...
    <div class="col-8">
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control" id="exampleInputAlamat1" placeholder="Masukan Alamat" name="alamat">
        </div>
        <div class="form-group">
        ...
        <div class="col-sm-10">
            <div class="form-check">
                <input class="form-check-input" type="radio" name="status_perkawinan_calon_baptis" id="gridRadios1" value="belum menikah" checked>
                <label class="form-check-label" for="gridRadios1">
                Belum menikah
                </label>
            </div>
            <div class="form-check">
                <input class="form-check-input" type="radio" name="status_perkawinan_calon_baptis" id="gridRadios2" value="akan menikah">
                <label class="form-check-label" for="gridRadios2">
                Akan Menikah dengan (tempat dan tanggal)
                </label>
            </div>
            <div class="form-check">
                <input class="form-check-input" type="radio" name="status_perkawinan_calon_baptis" id="gridRadios3" value="sudah menikah">
                <label class="form-check-label" for="gridRadios3">
                Sudah Menikah secara Gereja/KUA/Catatan Sipil/Cara Lain (dengan dan tempat & tanggal)
                </label>
            </div>
            <div class="form-check">
                <input class="form-check-input" type="radio" name="status_perkawinan_calon_baptis" id="gridRadios3" value="sudah berpisah">
                <label class="form-check-label" for="gridRadios3">
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control" id="exampleInputPelajaran1" placeholder="Masukan Sejak Kapan Mengikuti Pelajaran Agama" name="mengikuti_pelajaran_agama_sejak">
        </div>
        <div class="form-group">
            <label for="exampleInputPerayaan1">Mengikuti Perayaan Ekaristi Sejak</label>
            <input type="text" class="form-control" id="exampleInputPerayaan1" placeholder="Masukan Sejak Kapan Mengikuti Perayaan Ekaristi" name="mengikuti_perayaan_ekaristi_sejak">
        </div>
        <div class="form-group">
            <label for="exampleInputKegiatan1">Mengikuti Kegiatan Lingkungan Sejak</label>
            <input type="text" class="form-control" id="exampleInputKegiatan1" placeholder="Masukan Sejak Kapan Mengikuti Kegiatan Lingkungan" name="mengikuti_kegiatan_lingkungan_sejak">
        </div>
        <div class="form-group">
            <label for="exampleInputNamaGurus1">Nama Guru Agama yang mengajar</label>
            <input type="text" class="form-control" id="exampleInputNamaGuru1" placeholder="Masukan Nama Guru yang Mengajar" name="nama_guru_agama_yang_mengajar">
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control" id="exampleInpuPemberkatan1" placeholder="Masukan Pemberkatan dan Pembaptisan" name="pemberkatan_dan_pembaptisan">
        </div>
        <div class="form-group">
