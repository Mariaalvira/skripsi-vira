                        ...
                        <div class="col-sm-8">
                            <div class="form-check">
                                <input class="form-check-input" type="radio" name="nama_sakramen"
                                    id="gridRadios1" value="Baptis Anak" checked>
                            ...
                            <div class="form-check">
                                <input class="form-check-input" type="radio" name="nama_sakramen"
                                    id="gridRadios2" value="Baptis Dewasa">
                            ...
                            <div class="form-check">
                                <input class="form-check-input" type="radio" name="nama_sakramen"
                                    id="gridRadios3" value="Komuni Pertama">
                            ...
                            <div class="form-check">
                                <input class="form-check-input" type="radio" name="nama_sakramen"
                                    id="gridRadios3" value="Penguatan">
                                <label class="form-check-label" for="gridRadios3">
                                    Penguatan
                                </label>
                            </div>
                            <div class="form-check">
                                <input class="form-check-input" type="radio" name="nama_sakramen"
                                    id="gridRadios3" value="Perkawinan">
                                <label class="form-check-label" for="gridRadios3">
                                    Perkawinan
                                </label>
                            </div>
